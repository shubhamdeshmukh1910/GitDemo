...
public class StepDefination extends Utils{
	...
	@Then("vetrify place_id created maps to {string} using {string}")
	public void vetrify_place_id_created_maps_to_using(String expectedName, String resource) throws IOException {
	    // Write code here that turns the phrase above into concrete actions
